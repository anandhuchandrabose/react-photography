        ...
        <div className={`card text-center d-flex-column ${expanded ? 'expanded' : ''}`}>
            ...
            <div className="expandable-content text-center">
                ...
                <p style={{ opacity: expanded ? 1 : 0, transition: 'opacity 1.3s ease-in-out' }}>"When life becomes its own body"
                    <br /> <p className='eventvenue' style={{ opacity: expanded ? 1 : 0, transition: 'opacity 2.3s ease-in-out' }}>Photography exhibition,kochi</p>
                </p>
        ...
        <>
            ...
            <div className="container-fluid">
                <div className="container vh-100 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <img src="./12.jpeg" alt="Circle Image" className="circle-image p-1 shadow" />
                    ...
                    <a href="http://storiesofragooty.com/">
